...
class _NotesViewState extends State<UserNotesView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: StreamBuilder(
          stream: _notesService.allUserNotes(ownerUserId: userId).getLength,
      ...
      body: StreamBuilder(
        stream: _notesService.allUserNotes(ownerUserId: userId),
